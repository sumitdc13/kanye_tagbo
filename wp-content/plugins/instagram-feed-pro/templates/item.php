 ...
 *
 * @version 5.0 Instagram Feed Pro by Smash Balloon
 *
 */
...
$media_url               = SB_Instagram_Display_Elements_Pro::get_optimum_media_url( $post, $settings );
$media_full_res          = SB_Instagram_Parse_Pro::get_media_url( $post );
$sbi_photo_style_element = SB_Instagram_Display_Elements_Pro::get_sbi_photo_style_element( $post, $settings );
$media_all_sizes_json    = SB_Instagram_Parse_Pro::get_media_src_set( $post );
$img_alt                 = SB_Instagram_Parse_Pro::get_caption( $post, __( 'Image for post', 'instagram-feed' ) . ' ' . $post_id );
        ...
        <div class="sbi_link<?php echo esc_attr( $sbi_link_classes ); ?>" <?php echo $link_styles; ?>>
            <div class="sbi_hover_top">
                ...
                <p class="sbi_username">
                    <a href="<?php echo esc_url( 'https://instagram.com/' . $username ); ?>" target="_blank" rel="noopener" <?php echo $hover_styles; ?>><?php echo esc_html( $username ); ?></a>
                </p>
	            <?php endif; ?>
            ...
            <a class="sbi_instagram_link" href="<?php echo esc_url( $permalink ); ?>" target="_blank" rel="noopener" title="Instagram" <?php echo $hover_styles; ?>>
                <span class="sbi-screenreader"><?php _e( 'View on Instagram', 'instagram-feed' ); ?></span>
            ...
            <div class="sbi_hover_bottom" <?php echo $hover_styles; ?>>
                ...
                <p>
	                ...
	                <?php if ( ! empty( $location_info ) && SB_Instagram_Display_Elements_Pro::should_show_element( 'hoverlocation', $settings ) ) : ?>
                        <a href="<?php echo esc_url( 'https://instagram.com/explore/locations/' . $location_info['id'] ) ?>" class="sbi_location" target="_blank" rel="noopener" <?php echo $hover_styles; ?>data-lat="<?php echo esc_attr( $location_info['longitude'] ); ?>" data-long="<?php echo esc_attr( $location_info['lattitude'] ); ?>"><i class="fa fa-map-marker"></i><?php echo esc_html( $location_info['name'] ); ?></a>
	                <?php endif; ?>
                </p>
	            <?php endif; ?>
            ...
            <a class="sbi_link_area nofancybox" href="<?php echo $media_full_res; ?>" data-lightbox-sbi="" data-title="<?php echo str_replace( '&lt;br /&gt;', '&lt;br&gt;', esc_attr( nl2br( $caption ) ) ); ?>" data-video="<?php echo esc_attr( $lightbox_media_atts['video'] ); ?>" data-carousel="<?php echo esc_attr( $lightbox_media_atts['carousel'] ); ?>" data-id="sbi_<?php echo esc_attr( $post_id ); ?>" data-user="<?php echo esc_attr( $username ); ?>" data-url="<?php echo esc_attr( $permalink ); ?>" data-avatar="<?php echo esc_attr( $avatar ); ?>" data-account-type="<?php echo esc_attr( $account_type ); ?>">
                <span class="sbi-screenreader"><?php _e( 'Link to display lightbox', 'instagram-feed' ); ?></span>
				<?php echo $maybe_video_icon; ?>
            </a>
        </div>
