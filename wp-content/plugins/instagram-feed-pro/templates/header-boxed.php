...
<a href="<?php echo esc_url( 'https://www.instagram.com/' . $username ); ?>" target="_blank" rel="noopener"
   ...
   class="sbi_header_link">
    ...
    <div class="sbi_header_bar" <?php echo $header_bar_style; ?>>
        ...
        <a class="sbi_header_follow_btn<?php echo esc_attr( $follow_btn_classes ); ?>" href="https://instagram.com/<?php echo esc_url( $username ); ?>" target="_blank" rel="noopener" <?php echo $follow_btn_style; ?>>
