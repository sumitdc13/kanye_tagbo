        ...
        var a = jQuery,
            ...
            c = function() {
                ...
                return b.prototype.init = function() {
                            ...
                            jQuery.each(storyData,function(index,value) {
                                ...
                                if (value.media_type === 'VIDEO') {
                                    if (typeof value.media_url !== 'undefined') {
                                        ...
                                        d.album[index].link = value.permalink+'media?size=l'
                                    }
                                }
                    ...
                    if( this.album[this.currentImageIndex].carousel !== '' && typeof this.album[this.currentImageIndex].carousel.data !== 'undefined' && typeof this.album[this.currentImageIndex].carousel.data[0] !== 'undefined' ) {
    ...
    (function($){
        ...
        function SbiFeedPro(el, index, settings) {
            ...
            this.initLayout = function () {
                ...
                if (typeof settings.general.mediavine !== 'undefined') {
                    $sbi.addClass('sbi_mediavine');
                }

                if (typeof settings.general.modindex !== 'undefined') {
                    ...
                    settings.general.autoscroll = false;
                    settings.general.captionlinks = false;
                    var sbiModIndex = $sbi.attr('data-sbi-index');

                    if (parseInt(settings.general.modindex) === parseInt(sbiModIndex) || $sbi.hasClass('sbi_mod_merged') || jQuery('.sbi').length < 2) {
                    ...
                    if (modMode.status === true) {
                        ...
                        if(!modMode.$self.hasClass('sbi_mod_merged')) {
                            if (typeof settings.general.whiteListName !== 'undefined') {
                                modMode.setWhiteListData(settings.general.whiteListName, settings.general.whiteListIDs);
                            }
                            if (typeof settings.general.hidePhotos !== 'undefined') {
                ...
                } else if (typeof settings.general.carousel !== 'undefined') {
                    layout = 'carousel';
                } else if (typeof settings.general.highlight !== 'undefined') {
                    layout = 'highlight';
                } else if (typeof settings.general.masonry !== 'undefined') {
                    layout = 'masonry';
                }
                ...
                if ( layout === 'carousel' ) {
                    ...
                    var arrows = settings.general.carousel[0],
                        pagination = settings.general.carousel[1],
                        autoplay = settings.general.carousel[2],
                        time = settings.general.carousel[3],
                        loop = settings.general.carousel[4],
                        rows = settings.general.carousel[5];
                    //Initiate carousel
            ...
            this.revealNewImages = function() {
                ...
                if (feed.layout !== 'carousel' && typeof feed.settings.general.autoscroll !== 'undefined') {
